...
| Secondary | `#0F172A` | `--color-secondary` |
| CTA/Accent | `#F59E0B` | `--color-cta` |
| Background | `#F8FAFC` | `--color-background` |
| Text | `#0F172A` | `--color-text` |

**Color Notes:** Bold crimson red for action, ink black for professional strength, amber for safety/warning
