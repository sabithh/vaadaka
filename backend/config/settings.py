"""
Django settings for Vaadaka backend.
...
# Cloudinary — persistent cloud image storage
# Set these in .env and on Render's environment variables dashboard
CLOUDINARY_STORAGE = {
...
# Only use Cloudinary storage when credentials are configured
